...
struct CmAsn1Obj {
    struct CmAsn1Blob header;
    struct CmAsn1Blob value;
};

#define CM_ASN1_ENCODE_BYTE(ptr, value) \
do { \
    (ptr)[0] = (uint8_t)((value) & 0xff); \
    (ptr)++; \
} while (0)

#define CM_ASN1_ENCODE_TWO_BYTE(ptr, value) \
do { \
...
#define CM_ASN1_DECODE_BYTE(ptr, value) \
do { \
    (value) = (uint32_t)((ptr)[0]); \
    (ptr)++; \
} while (0)

#define CM_ASN1_DECODE_TWO_BYTE(ptr, value) \
do { \
