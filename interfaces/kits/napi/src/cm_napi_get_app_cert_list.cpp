...
static GetAppCertListAsyncContext CreateGetAppCertListAsyncContext()
{
...
static void DeleteGetAppCertListAsyncContext(napi_env env, GetAppCertListAsyncContext &context)
{
    if (context == nullptr) {
        return;
    }
...
static napi_value GetAppCertListParseParams(
...
static napi_value GetAppCertListWriteResult(napi_env env, GetAppCertListAsyncContext context)
{
...
static napi_value GetAppCertListAsyncWork(napi_env env, GetAppCertListAsyncContext context)
{
    ...
    NAPI_CALL(env, napi_create_async_work(
        ...
        [](napi_env env, napi_status status, void *data) {
            ...
            if (context->result == CM_SUCCESS) {
                ...
                const char *errorMessage = "get app cert list info error";
