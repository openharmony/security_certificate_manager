...
#ifndef CM_OPEN_UNINSTALL_DIALOG_H
#define CM_OPEN_UNINSTALL_DIALOG_H
...
public:
    CmOpenUninstallDialog(ani_env *env, ani_object aniContext, ani_enum_item aniCertType, ani_string aniCertUri,
        ani_object callback);
    ~CmOpenUninstallDialog() {};
...
#endif // CM_OPEN_UNINSTALL_DIALOG_H