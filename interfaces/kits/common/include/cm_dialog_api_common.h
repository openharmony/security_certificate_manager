...
static const std::unordered_map<int32_t, int32_t> DIALOG_CODE_TO_JS_CODE_MAP = {
    ...
    { DIALOG_ERROR_INSTALL_FAILED, DIALOG_ERROR_INSTALL_FAILED },
    { DIALOG_ERROR_PARAMETER_VALIDATION_FAILED, DIALOG_ERROR_PARAMETER_VALIDATION_FAILED },
};
...
static const std::unordered_map<int32_t, std::string> DIALOG_CODE_TO_MSG_MAP = {
    ...
    { DIALOG_ERROR_INSTALL_FAILED, DIALOG_INSTALL_FAILED_MSG },
    { DIALOG_ERROR_PARAMETER_VALIDATION_FAILED, DIALOG_OPERATION_FAILED_MSG + DIALOG_INVALID_PARAMS_MSG },
};
