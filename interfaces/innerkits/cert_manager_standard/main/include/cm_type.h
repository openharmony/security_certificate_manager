...
enum CmErrorCode {
    ...
    CMR_ERROR_VERIFY_PARAM_ERROR = -54,

    CMR_ERROR_IPC_WRITE_FAIL = -55,
    ...
    CMR_ERROR_INVALID_ARGUMENT_LENGTH_ZERO = -10015,
    CMR_ERROR_INVALID_ARGUMENT_LENGTH_TOO_LARGE = -10016,
